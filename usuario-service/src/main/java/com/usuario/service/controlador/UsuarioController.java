...
public class UsuarioController {
	...
	private ResponseEntity<List<Moto>> fallBackSaveMotos(@PathVariable("usuarioId") int id,@RequestBody Moto moto ,RuntimeException excepcion){
		return new ResponseEntity("El usuario: " + id + " no tiene dinero para las motos", HttpStatus.OK);
	}
	
	private ResponseEntity<List<Object>> fallBackGetTodos(@PathVariable("usuarioId") int id, RuntimeException excepcion){

...
public class UsuarioController {
	...
	private ResponseEntity<Carro> fallBackSaveCarros(@PathVariable("usuarioId") int id,@RequestBody Carro carro ,RuntimeException excepcion){
	...
	private ResponseEntity<Moto> fallBackSaveMotos(@PathVariable("usuarioId") int id,@RequestBody Moto moto ,RuntimeException excepcion){
